...
class LocalPsr4Autoloader implements LoaderInterface, Psr4GeneratorInterface
{
    /**
   ...
   public function withNamespace($prefix, $base_dir, $prepend = false)
    {
	   return $this->addNamespace($prefix, $base_dir, $prepend);
    }
