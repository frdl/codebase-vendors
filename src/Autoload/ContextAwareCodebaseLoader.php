...
*/
class ContextAwareCodebaseLoader implements 
	LoaderInterface, 
...
/**
	...
	protected function prepareOptions(){
		...
		$this->options['target'] = [
			'php' => (null !== $context && $context->getPhpVersion() instanceof ContextInterface) ? $context : \PHP_VERSION,
			'extensions'=>(null !== $context && is_array( $context->getExtensions() )   ) 
		               	    ? $context->getExtensions() 
			                : \get_loaded_extensions(),
		     'projects' => (null !== $context && is_array( $context->getProjects() )   ) 
		               	    ? $context->getProjects() 
			                : [],
		];		
