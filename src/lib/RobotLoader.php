...
namespace Webfan\FameFork\Nette\Loaders{
 ...
 * </code>
 */
class RobotLoader implements LoaderInterface, ClassLoaderInterface, ClassmapGeneratorInterface, ResolverInterface
{
	use Nette\SmartObject, DirectoriesTrait;
    const VERSION = 'v2';
...
*/	 				
	...
	public function getCacheFile($name = '_classes'): string
	{
		...
		return $this->tempDirectory . '/' . $name .'.'. sha1(serialize($this->getCacheKey())) . '.php';
	}
