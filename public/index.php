...
/**
$someDirsToFindComposerFiles=[
'webfan-legacy-and-patches',
 
'psr4',
'to-classmap', 
 
];
$DirsToFindComposerFiles=[];
 
 
 foreach($someDirsToFindComposerFiles as $subdir){
	/// * $DirsToFindComposerFiles[]=$loader->findIn( __DIR__ . \DIRECTORY_SEPARATOR. '..'. 
	//			  \DIRECTORY_SEPARATOR. '..'  .\DIRECTORY_SEPARATOR. $subdir.\DIRECTORY_SEPARATOR);  * /
	//			  
				  
	 $DirsToFindComposerFiles=array_merge($DirsToFindComposerFiles, glob( __DIR__ . \DIRECTORY_SEPARATOR. '..'. 
				  \DIRECTORY_SEPARATOR. '..'  .\DIRECTORY_SEPARATOR. $subdir.\DIRECTORY_SEPARATOR." * * /composer.json"));
 }

//print_r($DirsToFindComposerFiles);

//$composerFiles = $loader->findIn($DirsToFindComposerFiles, '*');

print_r($DirsToFindComposerFiles);
foreach($DirsToFindComposerFiles as $f){
  unlink($f);	
}
*/
?><!DOCTYPE HTML>
